...
typedef enum {
  ...
  /* IMPLEMENT ME */
  /* === start === */
  IMM_12_UNSIGNED, /* 12-bit unsigned number */
  IMM_5_UNSIGNED, /* 5-bit unsigned number */
  IMM_13_SIGNED, /* 13-bit signed number */
  IMM_21_SIGNED, /* 21-bit signed number */
  IMM_20_UNSIGNED, /* 20-bit unsigned number */
  IMM_32_UNSIGNED,
  IMM_32_SIGNED,
